...
\begin{frame}
    ...
    \begin{enumerate}
        \item \(v\) itself 
        \item a set containing all vertices which share a \(\text{\textcolor{red}{red}}\) edge with \(v\)
        \item and a set containing all vertices which share a \(\text{\textcolor{blue}{blue}}\) edge with \(v\)
    \end{enumerate}
    ...
    \pause
     ...
     If, for example, it is the \(\text{\textcolor{blue}{blue}}\) set you can keep picking vertices infinitely in that set which are in their \(\text{\textcolor{blue}{blue}}\) set to get a monochromatic subgraph.
     The same applies for if it is the \(\text{\textcolor{red}{red}}\) set. 
\end{frame}
