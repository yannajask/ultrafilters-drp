...
\begin{frame}
    \frametitle{Ultrafitler Shift}
    \begin{definition}
        Given an ultrafilter \(\mathcal{U}\) on \(\mathbb{N}\) and \(n \in \mathbb{N}\), we can define the shifted ultrafilter \(n + \mathcal{U}\) such that \(A \in n + \mathcal{U}\) if and only if
        \(\{m \in \mathbb{N} : n + m \in A\} \in \mathcal{U}\) for all \(A \subseteq \mathbb{N}\).
    \end{definition}
    \end{frame}
