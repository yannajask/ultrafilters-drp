...
\begin{frame}
    ...
    \begin{itemize}
        \item \(x_1 \in A\), so \(x_1\) is \textcolor{red}{red}
    ...
    Let \(A_1 = A \cap (A-x_1) \in \mathcal{U}\) and pick \(x_2 \in A_1\). Then, we have:\\
    \begin{itemize}
        \item \(x_2 \in A\), so \(x_2\) is \textcolor{red}{red}
        \item \(x_2 \in A-x_1\), so \(x_1 + x_2 \in A\) \pause
    \end{itemize}
    
    \vspace{10pt}

    Therefore \(x_1, x_2\), and \(x_1 + x_2\) are all \(\gamma\)-\textcolor{red}{red}! \qed
